...
def klik(sur):
    ...
    if x < sur.x < x + sirka and cas > 0:
        ...
        if 0 <= poradie < len(farby):
            ...
            if poradie == spravny:
                uhadol = True
                canvas.create_text(200, 130, text='Vyhral si!', font='Arial 30')
...
canvas.create_text(210, 20, text='Pyrotechnik', font='Arial 15', fill='blue')
canvas.create_text(210, 35, text='označ správny káblik')
